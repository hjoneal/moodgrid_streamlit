...
full_df = joblib.load("../data/pickles/updated_song_dataset.pkl")
...
if button("Get started", key="button1"):
    ...
    PLAYLIST_LINK = st.text_input("Enter the Spotify URL of a playlist you want to subset (Spotify Playlist -> o o o -> Share -> Copy link to playlist): ", value="https://open.spotify.com/playlist/5xeyTcyeRDcVCaYazJPCRQ?si=8a958d93924840c5", key="PLAYLIST_LINK")
    ...
    if button("Submit", key="button2"):
        ...
        # otherwise create an empty dataframe so the rest of the code runs
            ...
            api_cols = joblib.load("../data/pickles/api_cols.pkl")
        ...
        fullcols = joblib.load("../data/pickles/full_col_list.pkl")
        ...
        joblib.dump(full_df, "../data/pickles/updated_song_dataset.pkl")
